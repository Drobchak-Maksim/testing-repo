        ...
        <PortfolioContainerGrid>
          <ArticlePrtfolio row='1/4' zIndex={1}>
            <TeaxtContainer align='right' left='-5%'>
              ...
              <Paragraph>
                Mobile application - software designed to work on smartphones,
          ...
          <ArticlePrtfolio row='4/7' zIndex={3}>
            ...
            <TeaxtContainer align='left' left='5%'>
              ...
              <StyleHeadText>Full-cycle project </StyleHeadText>
              <Paragraph>
                INKSY - CRM system for printing and advertising agencies.
                State-of-the-art developments help INKSY to quickly manage all
                work processes. The system allows you to monitor the work of the
